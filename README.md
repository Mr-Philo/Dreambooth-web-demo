...
### Environment
```bash
conda create -n dbweb python=3.10
conda activate dbweb
pip3 install torch torchvision torchaudio
```
### Some basic requirements
```bash
pip3 install opencv-python streamlit
```
### For diffusers
```bash
...
```
### To run dreambooth example with a web demo, run
```bash
streamlit run Streamlit-Welcome.py
```
### If you want to train a model of your own, follow the original README.md ahead. Note that the model and output images will be presented as follows:
```text
Dreambooth - web demo
|-- assets
|-- class-images
|-- pages
|-- Users                 
    |-- person1           # each model folder for each person
        |-- log           
        |-- model         # All model file
        |-- output        # Default folder for output images
...
<br></br>
------
> original README.md from [huggingface/diffusers/dreambooth](https://github.com/huggingface/diffusers/tree/main/examples/dreambooth)
